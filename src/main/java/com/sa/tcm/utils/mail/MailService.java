...
public class MailService {
    ...
    private static final String USER = "sadaiyandi.m@infotrellis.com";     // Must be valid user in d.umn.edu domain, e.g. "smit0012"
    private static final String PASSWORD = "Apm624204"; // Must be valid password for smit0012
    private static final String FROM = "sadaiyandi.m@infotrellis.com";     // Full info for user, e.g. "Fred Smith <smit0012@d.umn.edu>"
}